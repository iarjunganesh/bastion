...
- **38** resources: four Cloud Run services, one Firestore database, two Pub/Sub topics, zero
  Scheduler jobs, two secrets, one Artifact Registry repository, one Agent Gateway, seventeen
  Registry services, one Model Armor template, two Agent Engines, and seven user-created service
  accounts.
