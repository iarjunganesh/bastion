...
| [04 — private fleet](evidence/04-private-fleet-deployment.md) | 21 APIs and 39 deployed resources measured without principals | Count-only inventory, not a request trace |
