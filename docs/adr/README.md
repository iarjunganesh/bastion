...
| One Google Agent Framework | [005](005-adk-as-the-agent-framework.md) | ✅ **Met.** ADK 2.7.1 — three `LlmAgent`s and two model-free `BaseAgent` steps under a `SequentialAgent`, executed |
