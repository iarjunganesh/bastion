...
- 208 tests at 100% statement and branch coverage under Python 3.12.
...
documentation, and diagram gates. The current local Python 3.12 result is **208 passed and
100.00% coverage**.
